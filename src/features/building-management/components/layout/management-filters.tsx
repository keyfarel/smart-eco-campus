  ...
  return (
    <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
      ...
      <div className="relative flex-1 md:flex-initial">
        ...
        <Input
          placeholder={activeTab === "buildings" ? "Search building name or ID..." : "Search room name, code or building..."}
          value={searchQuery}
          onChange={(e) => onSearchChange(e.target.value)}
          className="pl-9 h-9 w-full md:w-64 bg-zinc-950 border-zinc-855 text-xs text-zinc-300 placeholder:text-zinc-500 focus-visible:border-emerald-500 focus-visible:ring-emerald-500"
        />
      </div>
      ...
      {activeTab === "buildings" ? (
        <>
          ...
          <Select value={floorFilter} onValueChange={onFloorFilterChange}>
            <SelectTrigger className="h-9 w-36 bg-zinc-955 border-zinc-855 text-xs text-zinc-300 shrink-0 focus-visible:border-emerald-500 focus-visible:ring-emerald-500">
        ...
        <>
          ...
          <Select value={roomBuildingFilter} onValueChange={onRoomBuildingFilterChange}>
            <SelectTrigger className="h-9 w-44 bg-zinc-955 border-zinc-855 text-xs text-zinc-300 shrink-0 focus-visible:border-emerald-500 focus-visible:ring-emerald-500">
              <div className="flex items-center gap-1.5">
          ...
          <Select value={roomFloorFilter} onValueChange={onRoomFloorFilterChange}>
            <SelectTrigger className="h-9 w-32 bg-zinc-955 border-zinc-855 text-xs text-zinc-300 shrink-0 focus-visible:border-emerald-500 focus-visible:ring-emerald-500">
              <div className="flex items-center gap-1.5">
                <Layers className="w-3.5 h-3.5 text-zinc-500 shrink-0" />
